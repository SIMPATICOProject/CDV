...
export class SmartTables {
  ...
  settings: any;
  name: string = 'Service';
  objectJsonMethod: string = 'Method';
  objectJsonOperation: string = 'Operation';
  objectJsonCreated: string = 'Date';
   ...
   // this.translate.get('general.personal_data.values').subscribe(label => this.values = label)
    ...
    return {
      ...
      columns: {
        ...
        objectJsonMethod: {
          title: this.objectJsonMethod,
          type: 'string',
          filter: false,
          editable: false
        },
        objectJsonOperation: {
          title: this.objectJsonOperation,
          type: 'string',
          filter: false,
          editable: false
        },
        objectJsonCreated: {
          title: this.objectJsonCreated,
          type: 'string',
          width: '10px',
          filter: false,
          editable: false
